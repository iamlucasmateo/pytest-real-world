from logic.tennis_junior import tennis_score
import pytest


examples = (
    ("expected_score", "player1_points", "player2_points", "comment"), 
    [
        ...
        ("Advantage Player 2", 3, 4, "endgame, with uneven scores"),
        ("Advantage Player 2", 23, 24, "endgame, with uneven scores"),
